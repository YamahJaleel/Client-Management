...
public class Mainwindow extends JFrame {
	...
	private JLabel lblNom = new JLabel("Last Name");
	private JLabel lblPrenom = new JLabel("Name ");
	private JLabel lblEmail = new JLabel("Email ");
	private JLabel lblTelephone = new JLabel("Phone");

	private JRadioButton rdbtnNouvC = new JRadioButton("New client");
	private JRadioButton rdbtnAffiC = new JRadioButton("Show clients");
	private JRadioButton rdbtnTrouC = new JRadioButton("Find a client");

	private JButton btnValider = new JButton("Validate");
	private JButton btnEnregistrer = new JButton("Save");
	private JButton btnQuitter = new JButton("Quit");
	private JButton btnChercher = new JButton("Find");

	String[] Options = { "", "Last name", "Name", "Phone", "Email" };
	...
	public Mainwindow() {
		...
		JLabel lblOption = new JLabel("Please choose an option");
		...
		btnValider.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (rdbtnAffiC.isSelected()) {
					...
					Secondarywindow Affichage = new Secondarywindow(s);
		...
		btnChercher.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Secondarywindow Affichage = new Secondarywindow(s1);
				Affichage.setResizable(true);
				Affichage.setLocationRelativeTo(null);
				Affichage.setVisible(true);
